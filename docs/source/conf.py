# -*- coding: utf-8 -*-
#
# ndmg documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../../ndmg/register'))
...
latex_documents = [
  (master_doc, 'ndmg.tex', u'ndmg Documentation',
   u'NeuroData', 'manual'),
]
...
man_pages = [
    (master_doc, 'ndmg', u'ndmg Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'ndmg', u'ndmg Documentation',
   author, 'ndmg', 'One line description of project.',
   'Miscellaneous'),
]
